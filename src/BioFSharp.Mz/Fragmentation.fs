...
//        rawMass |> List.map (fun n ->  n - currentCO)
    ...
    let isAminoLoss =
        let aaAminoLoss = [AminoAcids.Arg;AminoAcids.Lys;AminoAcids.Gln;AminoAcids.Asn;] |> Set.ofList
        (fun (a:AminoAcids.AminoAcid) -> aaAminoLoss.Contains(a))
        

    let isWaterLoss =
        let aaWaterLoss = [AminoAcids.Ser;AminoAcids.Thr;AminoAcids.Glu;AminoAcids.Asp;] |> Set.ofList
        (fun (a:AminoAcids.AminoAcid) -> aaWaterLoss.Contains(a))        
