...
let referenceBinaries = ["BioFSharp.IO.dll";]//"BioFSharp.Mz.dll";"BioFSharp.Stats.dll"; "FSharpAux.dll";] // "FSharpAux.dll";"FSharpAux.IO.dll";
...
let info =
  [ "project-name", "BioFSharp"
    ...
    "project-summary", "Official git repository for BioFSharp"
...
let tmpBin = [@"C:\Users\muehl\OneDrive\Development\Source\BioFSharp\bin\BioFSharp.dll";]
